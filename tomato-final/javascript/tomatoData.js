const varieText = {
  ...
  sproutText: {
    textOriginal: "Finally, the seed baby sprouted",
    textContent:
  ...
  sunText: {
    textOriginal: "Your tomato plants love sunny weather:)",
    textContent:
  ...
  cutText: {
    textOriginal: "Wow It's now 14 inch tall, time to prune!",
    textContent:
  ...
  beeText: {
    textOriginal: "Thank you bumblebee!",
    textContent:
  ...
  greenText: {
    textOriginal: "Wait a bit! I'm unripen.",
    textContent:
  ...
  tomatoText: {
    textOriginal: "Yay, we finally get a cute tomato baby.",
    textContent:

...
function didSlidesChange() {
  return (
    utils.getVisible(utils.$(getOptions().slideSelector, getContainer()))
      .length !== getState().numSlides
  );
}

function didSectionsChange() {
  return (
    utils.getVisible(utils.$(getOptions().sectionSelector, getContainer()))
      .length !== getState().numSections
  );
}

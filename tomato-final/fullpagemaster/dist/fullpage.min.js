...
!(function (n, t) {
        ...
        if (vn.G) {
          ...
          e && (v = o.fp_easings[bt().easing](s, a, u, e)),
            ...
            s < e
              ...
              : void 0 === i || c || (i(), dn({ G: !1 }), (c = !0));
        } else c || l || (i(), dn({ G: !1 }), (c = !0));
      }),
      window.requestAnimationFrame(Wt);
  }
  function Kt(n) {
    ...
    var e = (function (n, t) {
      var e = {
        afterRender: function () {
          return { section: Kt(hn().F), hn: qt(hn().F.activeSlide) };
        },
        onLeave: function () {
          return {
            origin: Kt(t.items.origin),
            destination: Kt(t.items.destination),
          ...
          (function (n, t, e) {
            ...
            if (
              ...
              (f.test.left[t.sectionIndex] = Math.round(r.left)),
                Gt(n, Math.round(r.left), bt().scrollingSpeed, function () {
                  de(t);
                });
          })(n, c));
  }
      ...
      if (
        ...
        bt().autoScrolling &&
          ...
          (u = (function (n) {
            ...
            var t = hn().F.item;
            return (
              n.isMovementUp ? B(t, tn(t, Kn)) : N(t, en(t, Kn).reverse()),
          ...
          (function (n) {
            ...
            if (
              (dn({ q: "none", scrollY: Math.round(n.dtop) }),
              sn.D(Dn),
              ...
              (f.test.top = -n.dtop + "px"),
                clearTimeout(Oe),
                Gt(i.element, i.options, bt().scrollingSpeed, function () {
                  bt().scrollBar
                    ? (Oe = setTimeout(function () {
                        Ee(n);
                      }, 30))
  ...
  function Ke() {
    ...
    (Ue = qe(vn.F)),
      (_e = qe(vn.F ? vn.F.activeSlide : null)),
      (vn.R = t.length),
  ...
  function Je() {
    L(p(bt().sectionSelector, wt()), Gn), L(p(bt().slideSelector, wt()), $n);
  }
  function Ze(n) {
  ...
  var ii = (function () {
    ...
    try {
      ...
      G("testPassive", null, t), q("testPassive", null, t);
    } catch (n) {}
    return function () {
      return n;
    };
  ...
  function fi() {
    ...
    (f.test.top = -n + "px"),
      dn({ K: !1 }),
      Gt(t.element, t.options, bt().scrollingSpeed, function () {
        setTimeout(function () {
          dn({ B: !0 }), dn({ K: !0 });
        }, 30);
      });
  ...
  function vi() {
    ...
    dn({ K: !1 }),
      Gt(n.element, n.options, bt().scrollingSpeed, function () {
        dn({ K: !0 }), dn({ B: !1 }), dn({ In: !1 });
      });
  }
  var di,
    hi,
  ...
  function Ri(n) {
    var t = F(n.target, Kn) || hn().F.item,
      e = Ve.Sn(hn().F);
    if (Pi(n)) {
      dn({ X: !0, J: !1 }), bt().autoScrolling && e && !vn.K && V(n);
      var i = Fi(n);
      (ki = i.y), (Li = i.x);
  ...
  function zi(n) {
    if ((bt().fitToSection && dn({ G: !1 }), Pi(n))) {
      var t = Fi(n);
      (Oi = t.y), (ji = t.x);
    }
    G("touchend", Ci);
  ...
  function Ni(n) {
    bt().autoScrolling && Pi(n) && ce().m.up && (vn.K || V(n));
  }
  function Bi(n, t) {
  ...
  function Gi() {
    clearTimeout(Mi), K("keydown", Ki), K("keyup", qi);
  }
  function Ki(n) {
    clearTimeout(Mi);
    var t,
  ...
  function eo(n) {
    ...
    if ((vn.J || dn({ X: !1, J: !0, q: "none" }), !ce().m.down && !ce().m.up))
      return V(n), !1;
    if (i) return !0;
    if (!1 === i) return V(n), !1;
            ...
            .forEach(function (n) {
              if (!e) {
                var t = Q(i, n),
                  o = F(i, n);
                (t || o) &&
                  (f.shared.Gn || ro(!1), (f.shared.Gn = !0), (e = !0));
              }
            }),
          !e && f.shared.Gn && (ro(!0), (f.shared.Gn = !1))))
      : ro(!0);
  }
  function fo(n, t) {
  ...
  var so,
    ...
    go = !1;
  function mo() {
    clearTimeout(so), clearTimeout(vo), q("resize", wo);
  }
  function wo() {
    go ||
  ...
  (f.reBuild = bo),
    sn.L(yn, function () {
      wo(), G("resize", wo), sn.L(Sn, mo);
    }),
    (f.setLockAnchors = function (n) {
      bt().lockAnchors = n;
    }),
    sn.L(yn, function () {
      G("hashchange", Mo), sn.L(Sn, To);
    }),
    sn.L(yn, function () {
  ...
  function No() {
    ...
    "" === bt().licenseKey.trim()
      ...
      : (bt() && vn.qn) || r.domain.indexOf("alvarotrigo.com") > -1
      ? n && n.length
      : (v(
          "error",
  ...
  function Bo(n, t) {
    ...
    if (
      ...
      return (
        ...
        (f.shared = Object.assign(f.shared, { Yn: null, Gn: !1 })),
        (o.fullpage_api = f),
        ...
        n &&
          ...
          xt(hn().vn).forEach(function (n) {
            bt().scrollOverflow && Ve.Rn(n),
              ...
              m(n, Gn) && !pt && n.removeAttribute("data-anchor");
          }),
          Ft(wt()),
          [qn, tt, Zn].forEach(function (n) {
